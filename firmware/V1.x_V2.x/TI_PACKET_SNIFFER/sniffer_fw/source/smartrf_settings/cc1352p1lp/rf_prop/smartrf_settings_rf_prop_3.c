...
uint32_t RFProp3_pOverridesTxStd[] =
{
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA
uint32_t RFProp3_pOverridesTx20[] =
{
    // The TX Power element should always be the first in the list
...
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t RFProp3_cmdPropRadioDivSetup =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    ...
    .txPower = 0x003F,
    .pRegOverride = RFProp3_pOverrides,
    .centerFreq = 0x01B1,
    .intFreq = 0x8000,
    .loDivider = 0x0A,
    .pRegOverrideTxStd = RFProp3_pOverridesTxStd,
    .pRegOverrideTx20 = RFProp3_pOverridesTx20
};
