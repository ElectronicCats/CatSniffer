...
uint32_t RFProp0_pOverridesTxStd[] =
{
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA
uint32_t RFProp0_pOverridesTx20[] =
{
    // The TX Power element should always be the first in the list
...
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t RFProp0_cmdPropRadioDivSetup =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    ...
    .intFreq = 0x8000,
    .loDivider = 0x05,
    .pRegOverrideTxStd = RFProp0_pOverridesTxStd,
    .pRegOverrideTx20 = RFProp0_pOverridesTx20
};
